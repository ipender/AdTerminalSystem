...
public class AnyRTMP {
    ...
    private static final String TAG = "AnyRTMP";
    /**
     * 加载api所需要的动态库
     */
    static {
    ...
    private final EglBase14 mEglBase14;

    private AnyRTMP() {
        executor = new LooperExecutor();
        eglBase = EglBase.create();
        if (!EglBase14.isEGL14Supported()) {
            Logging.d(TAG, "EglBase14 is not supported in this device");
            mEglBase14 = null;
        } else {
//            mEglBase14 = new EglBase14(null, );
            mEglBase14 = null;
        }
